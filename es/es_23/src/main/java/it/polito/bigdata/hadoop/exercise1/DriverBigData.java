...
import it.polito.bigdata.hadoop.exercise1.ReducerBigData;
...
public class DriverBigData extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    if (exitCode == 0) {
      ...
      job2.addCacheFile(
              new Path( "C:/Users/vcata/Desktop/Polito/Big Data/HADOOP/esercizi/es/es_23/res/part-r-00000").toUri());
